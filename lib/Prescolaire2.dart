...
class Prescolaire2 extends StatefulWidget {
  const Prescolaire2({super.key});

  @override
  State<Prescolaire2> createState() => _PrescolaireState();
}

class _PrescolaireState extends State<Prescolaire2> {
                    ...
                    return MaterialButton(
                      ...
                      onPressed: (){
                        if(formKey.currentState!.validate()){
                          ...
                          print(test2.text);
                          print(test3.text);
                          var enfant=Enfant(Nom, Prenom, Date, Convention, Transport);
                          
                          
                          if (!enfant.EnfantValide()) {
                            showDialog(
                              context: context,
                              builder: (context) {
                                return AlertDialog(
                            ...
                            double total = enfant.calculerMontant();
                            print(total.toString()+'MAD');
                            DateTime dateTime = DateTime.parse(Date);
                            print(dateTime);
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Details(enfant)),
                            );
                          }
                        }
